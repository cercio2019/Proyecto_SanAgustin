<div class="btn-group ml-5 mt-1">
   ...
   <a href="index.php?action=registros" class="dropdown-item text-white ">Familias</a>
   	<a href="index.php?action=discapacitados" class="dropdown-item text-white ">Discapacitados</a>
     <a href="index.php?action=TerceraEdad" class="dropdown-item text-white">Tercera edad</a>
   </div>
  </div>  
